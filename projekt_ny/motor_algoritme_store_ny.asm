...
OPTIMERLIGEUD:
	LDI	R16,255			;Sætter tophastighed, hvis vi ikke er på den
	OUT	OCR2,R16
	CALL	DELAYLIGEUD
...
REELERIETANDETSVING:
	CPI	ACCdata,70		;Tjekker hvornår vi kommer ud af sving til den anden side (høje sving)
	BRLO	REELUDAFSVING2
	JMP	TJEKREEL
...
REELSKIP:
	...
	JMP	TJEKREEL
REELSTADIGISVING2:
	CPI	ACCdata,75		;Hvis 2 målinger ikke siger den er sving, clear den sving
